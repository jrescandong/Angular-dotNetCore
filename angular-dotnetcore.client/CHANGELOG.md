...
- Create Angular project with ng: `ng new angular-dotnetcore.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`angular-dotnetcore.client.esproj`).
